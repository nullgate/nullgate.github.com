...
(function() {
  ...
  window.Breadcrumb = (function() {
    ...
    Breadcrumb.prototype._makeCrumb = function(x, y, text, active) {
      ...
      x = parseInt(x);
      fontSize = 15;
      s = this.r.text(0, 0, text).attr({ font: "" + fontSize + "px 'Tahoma', Fontin-Sans, sans-serif", "text-anchor":"start"  });
		//this.r.print(0, 0, text, this.r.getFont("Museo Sans 500"), fontSize);
      ...
      if (isStart) {
        c.mytext =  this.r.text(x + padding, ty, text).attr({ font: "" + fontSize + "px 'Tahoma', Fontin-Sans, sans-serif", "text-anchor":"start" });
		//this.r.print(x + padding, ty, text, this.r.getFont("Museo Sans 500"), fontSize);
      } else {
        c.mytext =  this.r.text(x + padding + arrowWidth, ty, text).attr({ font: "" + fontSize + "px 'Tahoma', Fontin-Sans, sans-serif", "text-anchor":"start" });
		//this.r.print(x + padding + arrowWidth, ty, text, this.r.getFont("Museo Sans 500"), fontSize);
      }
      if (active) {
        c.mytext.attr({
          fill: '#fff'
